...
<section class="slider pt-0">
	<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
    	<div class="carousel-inner">
            <div class="carousel-item active slider-area background_bg" data-img-src="{{ asset('frontend/image/slider-img-1.jpgs') }}">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-7 col-9">
                                <div class="slider-caption">
                                    ...
                                    <a href="shop.html" class="btn btn-primary animation" data-animation="fadeInUp" data-animation-delay="1s">Shop Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="carousel-item slider-area background_bg" data-img-src="{{ asset('frontend/image/slider-img-1.jpg') }}">
