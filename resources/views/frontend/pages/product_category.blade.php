                        ...
                        <div class="header-right">
                            ...
                            <div class="cart-box">
                                ...
                                <div class="cart-prodect d-flex">
                                    <div class="cart-img">
                                        <img src="image/placeholder_1.jpg" alt="cart-img">
                                    </div>
                                ...
                                <li>
                                    ...
                                    <div class="sub-menu mega-menu dropdown-menu">
                                        <ul>
                                            ...
                                            <li class="submenu-img"><A href="#"><img src="image/placeholder_2.jpg" alt="banner"></a></li>
                                        </ul>
                                    </div>
                                </li>
...
<section class="breadcrumbs-section background_bg" data-img-src="image/placeholder_8.jpg">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8 col-md-12">
                ...
                <div class="row list_grid_container grid justify-content-center">
                    <div class="col-md-4 col-6">
                        <div class="product-box common-cart-box box-1">
                            <div class="product-img common-cart-img">
                                <img src="image/placeholder_4.jpg" alt="product-img">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="product-box common-cart-box box-2">
                            <div class="product-img common-cart-img">
                                <img src="image/placeholder_4.jpg" alt="product-img">
                                <div class="hover-option">
                                    <div class="add-cart-btn">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="product-box common-cart-box box-3">
                            <div class="product-img common-cart-img">
                                <img src="image/placeholder_4.jpg" alt="product-img">
                                <div class="hover-option">
                                    <div class="add-cart-btn">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="product-box common-cart-box box-4">
                            <div class="product-img common-cart-img">
                                <img src="image/placeholder_4.jpg" alt="product-img">
                                <div class="hover-option">
                                    <div class="add-cart-btn">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="product-box common-cart-box box-5">
                            <div class="product-img common-cart-img">
                                <img src="image/placeholder_4.jpg" alt="product-img">
                                <div class="hover-option">
                                    <div class="add-cart-btn">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="product-box common-cart-box box-6">
                            <div class="product-img common-cart-img">
                                <img src="image/placeholder_4.jpg" alt="product-img">
                                <div class="hover-option">
                                    <div class="add-cart-btn">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="product-box common-cart-box box-8">
                            <div class="product-img common-cart-img">
                                <img src="image/placeholder_4.jpg" alt="product-img">
                                <div class="hover-option">
                                    <div class="add-cart-btn">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="product-box common-cart-box box-9">
                            <div class="product-img common-cart-img">
                                <img src="image/placeholder_4.jpg" alt="product-img">
                                <div class="hover-option">
                                    <div class="add-cart-btn">
                    ...
                    <div class="side-quantity-box side-box">
                        ...
                        <div class="quantity-box-detail">
                            <ul>
                                ...
                                <li><a href="#">grey<span>(07)</span></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="side-quantity-box side-box">
                        ...
                        <div class="side-recent-product">
                            <div class="cart-prodect d-flex">
                                <div class="cart-img">
                                    <img src="image/placeholder_1.jpg" alt="recent-product">
                                </div>
                                <div class="cart-product">
                                    <a href="product-detail.html">Ornare sed consequat</a>
                                    <a href="product-detail.html" class="cp-comments"><i class="fa fa-comments"></i> 5 Comments</a>
                                </div>
                            </div>
                            <div class="cart-prodect d-flex">
                                <div class="cart-img">
    ...
    <div class="row">
        <div class="col-md-5">
             <div class="product-image">
                <img id="product_img" src='image/placeholder_10.jpg' data-zoom-image="image/placeholder_10.jpg"/>
             </div>
             <div id="pr_item_gallery" class="product_gallery_item owl-thumbs-slider owl-carousel owl-theme">
                <div class="item">
                    <a href="#" class="active" data-image="image/placeholder_10.jpg" data-zoom-image="image/placeholder_10.jpg">
                        <img src="image/placeholder_9.jpg" />
                    </a>
                </div>
                <div class="item">
                    <a href="#" data-image="image/placeholder_10.jpg" data-zoom-image="image/placeholder_10.jpg">
                        <img src="image/placeholder_9.jpg" />
                    </a>
                </div>
            </div>
